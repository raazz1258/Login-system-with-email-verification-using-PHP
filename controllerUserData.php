...
if(isset($_POST['signup'])){
    ...
    $url = 'https://www.google.com/recaptcha/api/siteverify?secret=' . urlencode($private_key) .  '&response=' . urlencode($captcha);
    ...
    if(count($errors) === 0){
        ...
        if($data_check){
            ...
            $sender = "From: raazzchaudhary9@gmail.com";
    ...
    if(isset($_POST['check-reset-otp'])){
        ...
        if (!preg_match($pattern_up, $password)) {
            $errors[] = "Must be at least 8 character long and please include at least 1 uppercase character, 
